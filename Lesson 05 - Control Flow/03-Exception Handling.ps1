# Error handling in PowerShell can be a little tricky, so pay special attention to this
# section of the workshop!

$VerbosePreference = 'continue'

# In the original version of PowerShell, you would use a "trap" statement
# to catch errors that occurred in your scripts.
...
# Newer versions of PowerShell support try..catch statements
# IMPORTANT: There's a difference between "terminating" and "non-terminating errors."
#   The try..catch statement will ONLY catch "terminating" errors.
...
# We need to turn the non-terminating error into a terminating error. 
# To do this, either: 1) add "-ErrorAction Stop" to the command invocation, or set $ErrorActionPreference = 'Stop'
try {
...
# Example: I don't care if this command doesn't exist .. keep executing.
#   In this example, the error won't be written to the Error stream, but it will appear in the $Error variable.
